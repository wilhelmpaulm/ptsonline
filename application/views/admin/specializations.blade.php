    ...
    <body>
                ...
                <div class="container">
                    ...
                    <div class="nav-collapse">
                        <ul class="nav">
                            ...
                            <li class="active"><a href="{{URL::to('admin/specializations')}}">Specializations</a></li>
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <table class="table table-bordered table-striped table-condensed table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><form action="{{URL::to_action('admin@specializations@delete')}}" method="POST">
                                        <input type="hidden" name="id" value="{{$specialization->id}}" />
                                        <input type="submit" value="Delete"  class="btn btn-danger"/>
                                    </form></td>
                                                                    <td><a class="btn" data-toggle="modal" href="#{{$specialization->id}}">Edit</a></td>
                ...
                <div class=" span4">
                    <form class="form-horizontal" method="POST" action="{{URL::to_action('admin@specializations@new')}}">
                        <fieldset>
                            <legend>Add Specialization</legend>
                            <div class="control-group">
                                <label class="control-label" for="input01">Specialization/Course Code</label>
                                <div class="controls">
...
@foreach($specializations as $specialization)
        <div class="modal hide fade" id="{{$specialization->id}}">
            <div class="modal-header">
                <a class="close" data-dismiss="modal">&times;</a>
                <h3>Edit Specialization</h3>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" action="{{URL::to_action('admin@specializations@edit')}}" method="POST">
	<fieldset>
		<legend>{{$specialization->title}}</legend>
                <input type="hidden" name="id" value="{{$specialization->id}}" />
		<div class="control-group">
			<label class="control-label" for="input01">Code</label>
			<div class="controls">
                            <input type="text" class="input-xlarge" id="input01" name="code" value="{{$specialization->code}}">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="input01">Title</label>
			<div class="controls">
                            <input type="text" class="input-xlarge" id="input01" name="title" value="{{$specialization->title}}">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="textarea">Description</label>
			<div class="controls">
                            <textarea class="input-xlarge" id="textarea" rows="3" name="description">{{$specialization->description}}</textarea>
			</div>
		</div>
		<div class="form-actions">
			<button type="submit" class="btn btn-primary">Save changes</button>
