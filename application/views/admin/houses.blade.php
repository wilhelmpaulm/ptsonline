...
<div class="navbar navbar-fixed-top">
                ...
                <div class="container">
                    ...
                    <div class="nav-collapse">
                        <ul class="nav">
                            ...
                            <li class="active"><a href="{{URL::to('admin/houses')}}">Houses</a></li>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="span7" style="height: 360px;overflow-y: scroll">
                    <table class="table table-bordered table-striped table-condensed table-hover">
                        ...
                        <tbody >
                            ...
                            <tr>
                                <td><?= HTML::image("img/houses/".$house->picture, $house->picture, array(
                                   'style' => "height:100px",
                                    'class' => "img-circle"
                                ))?></td>
                                <td>{{$house->name}}</td>
                                ...
                                <td>{{$house->active}}</td>
                                <td><form action="{{URL::to_action('admin@houses@delete')}}" method="POST">
                                        <input type="hidden" name="id" value="{{$house->id}}" />
                                        <input type="submit" value="Delete"  class="btn btn-danger"/>
                                    </form></td>
                                <td><a class="btn" data-toggle="modal" href="#{{$house->id}}">Edit</a></td>
                ...
                <div class=" span4">
                    <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{URL::to_action('admin@houses@new')}}">
                        <fieldset>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea class="input-xlarge" id="textarea" rows="3" name="mission"></textarea>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="textarea">Vision</label>
                                <div class="controls">
                                    <textarea class="input-xlarge" id="textarea" rows="3" name="vision"></textarea>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="select01">Active</label>
                                <div class="controls">
                                    <select id="select01" name="active">
        ...
        @foreach($houses as $house)
        <div class="modal hide fade" id="{{$house->id}}">
            <div class="modal-header">
                <a class="close" data-dismiss="modal">&times;</a>
                <h3>Edit milestone</h3>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" action="{{URL::to_action('admin@houses@edit')}}" method="POST" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <div class="control-group">
                            <label class="control-label" for="input01">Name</label>
                            <div class="controls">
                                <input type="text" class="input-xlarge" id="input01" name="name" value="{{$house->name}}">
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="textarea">Description</label>
                            <div class="controls">
                                <textarea class="input-xlarge" id="textarea" rows="3" name="description">{{$house->description}}</textarea>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="textarea">Mission</label>
